...
const Leaderboard = () => {
  const players = [
    { name: 'MrFakon', points: [2,3,4,3,5,3] },
    { name: 'TakRiuto', points: [2,2,3,3,2,2] },
    { name: 'Isehnia', points: [1,3,4,2,2,2] },
    { name: 'Spike', points: [0,2,4,3,5,2] },
    { name: 'Damian', points: [2,3,4,4,4,4] },
    { name: 'Raledro', points: [2,1,3,4,4,3] },
    { name: 'Ursus', points: [3,2,2,4,4,4] },
    { name: 'Papelon', points: [0,3,3,4,3,1] },
    { name: 'Devmon', points: [2,3,3,1,2,1] },
    { name: 'Eduamen', points: [2,2,4,2,3,1] },
    { name: 'Joe', points: [0,4,3,3,4,2] },
    { name: 'Carlos', points: [0,3,3,3,5,4] },
  ];
